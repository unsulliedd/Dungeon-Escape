...
// MossGiant class inherits from Enemy and implements IDamageable interface
    ...
    public void Damage()
    {
        if (!isDead)
        {
            ...
            if (Health < 1)
            {
                ...
                AudioManager.Instance.PlayMossGiantSounds(1, transform.position);   // Play MossGiant death sound
